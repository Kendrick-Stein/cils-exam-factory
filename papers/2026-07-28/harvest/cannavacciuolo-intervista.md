...
usable_levels: B1,B2
words: 365
fetch_intent: B1/T5 (over-fetch, not used — banked for future B1/B2 interviste slots)
---

CEFR grading: ACCEPT (target B2, usable down to B1).
- Evidence: (1) intervista autentica con domande in grassetto già nel formato richiesto dal genere "intervista" (nessuna ricomposizione necessaria); (2) risposte dell'intervistato con frasi lunghe, alcuni incisi e lessico di settore (cucina, gestione di una "brigata", "materie prime") — registro B2; (3) buona varietà di tempi: presente ("comando", "credo", "significa"), passato prossimo ("è nato", "è diventato", "ho creato", "ho accolto"), imperfetto assente ma narrazione di percorso professionale ricca di connettori temporali.
- Anchor: confrontabile con le interviste a personaggi pubblici usate nei fascicoli B2 CILS (chef/artista che ripercorre la propria carriera).
- Numbers: 365 parole (5 scambi D/R), media ≈ 24 parole/frase, lessico difficile stimato ≈ 7% (termini di settore gastronomico).
- Adaptation plan for B1 use: tagliare 2 dei 5 scambi D/R (mantenere quelli con più passato prossimo/presente e meno lessico tecnico) e sostituire "brigata"/"materie prime" con equivalenti più comuni se serve abbassare il registro.
